...
const MyStories: React.FC = () => {
  ...
  className="glass-effect rounded-2xl p-4 mb-6 shadow-xl backdrop-blur-xl bg-white/95 border border-white/20"
      >
  <h2 className="text-4xl font-bold text-slate-800 mb-6 flex items-center">
          <span className="bg-gradient-to-r from-blue-500 to-purple-500 w-2 h-12 rounded-full mr-4"></span>
  ...
  className="glass-effect rounded-2xl p-4 mb-6 shadow-xl backdrop-blur-xl bg-white/95 border border-white/20"
      >
  <h2 className="text-4xl font-bold text-slate-800 mb-6 flex items-center">
          <span className="bg-gradient-to-r from-purple-500 to-pink-500 w-2 h-12 rounded-full mr-4"></span>
  ...
  className="glass-effect rounded-2xl p-4 shadow-xl backdrop-blur-xl bg-white/95 border border-white/20"
      >
  <h2 className="text-4xl font-bold text-slate-800 mb-6 flex items-center">
          <span className="bg-gradient-to-r from-indigo-500 to-blue-500 w-2 h-12 rounded-full mr-4"></span>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-lg leading-relaxed mb-4">"Maaf, aku terlalu terburu-buru tadi. Besok kita bahas lagi, pelan-pelan."</p>
          ...
          <p className="text-lg leading-relaxed mb-4">"Oke, aku juga maaf kalau tadi terlalu sensitif. Besok kita cari titik tengah, ya."</p>
