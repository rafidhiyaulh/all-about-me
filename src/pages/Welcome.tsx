  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <h1 className="mb-4 text-4xl font-bold leading-tight bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 bg-clip-text text-transparent sm:text-5xl lg:text-7xl">
          Selamat Datang
        </h1>
        <motion.p 
          initial={{ opacity: 0 }}
          ...
          className="text-base font-medium text-slate-600 sm:text-lg md:text-2xl"
        >
      ...
      <motion.div
        ...
        className="glass-effect mb-6 rounded-2xl border border-white/20 bg-white/95 p-5 shadow-xl backdrop-blur-xl sm:p-6"
      >
      ...
      <div className="highlight-box mb-6 rounded-xl p-5 sm:p-6">
